...
--
-- Host: localhost
-- Generation Time: Feb 15, 2015 at 05:19 AM
...
CREATE TABLE IF NOT EXISTS `tbl_data_dp3` (
  ...
  `kesetiaan` int(100) NOT NULL,
  `prestasi` int(100) NOT NULL,
  `tanggung_jawab` int(100) NOT NULL,
  `ketaatan` int(100) NOT NULL,
  `kejujuran` int(100) NOT NULL,
  `kerjasama` int(100) NOT NULL,
  `prakarsa` int(100) NOT NULL,
  `kepemimpinan` int(100) NOT NULL,
...
(7, 9, 5, '124', '2015-02-07', '123', '123', '2015-02-01', '15/02/2015', '45 Tahun 1 Bulan', '1212');
...
(3, 6, 4, '112', '123', '2015-02-15', '2013-02-01', '15/02/2015', '2 Tahun 1 Bulan', '123');
...
(3, 6, '123', '123', '2015-02-14'),
(2, 6, '123', '1312', '2015-02-12'),
(4, 6, '123', '123', '2015-02-02'),
(5, 6, '123', '123', '2015-02-14');
...
(14, 6, 1, '123', '4', '2015-02-11', '123', '123');
...
(9, 6, '123', '123', '2015-11-02'),
(8, 6, '123', '1231', '2015-02-08T17:00:00.000Z');
...
CREATE TABLE IF NOT EXISTS `tbl_master_unit_kerja` (
  ...
  `eselon` int(50) NOT NULL,
  `parent_unit` int(50) NOT NULL,
...
(1, 'DIREKTORAT JENDERAL BINA MARGA', 23, 0),
(2, 'SEKRETARIAT DIREKTORAT JENDERAL BINA MARGA', 25, 1),
(31, 'BALAI PELAKSANAAN JALAN NASIONAL XI, DITJEN BINA MARGA', 0, 0),
(32, 'SUB BAGIAN TATA USAHA, BPJN XI, DITJEN BINA MARGA', 0, 0),
(33, 'SEKSI PERENCANAAN DAN PELAKSANA, BPJN XI, DITJEN BINA MARGA', 0, 0),
(34, 'SEKSI PENGENDALIAN SISTEM, PELAKSANAAN, PENGUJIAN DAN PERALATAN, BPJN XI, DITJEN BINA MARGA', 0, 0);
...
(1, 'administrator', '57da22ad2deccfc4725ce1cc76d55a2a', 'Administrator', 'administrator');
...
(1, 1, '127.0.0.1', 0, 0, 0, '2015-02-14 01:45:12', NULL, NULL);
...
(1, 'john.doe@example.com', '$2y$10$shpRf8eOoWN5WYIYJmeCe.3e98mcmKAezEqDRRPB5uWsUEk5pxPzS', NULL, 1, NULL, NULL, '2015-02-15 04:31:28', '$2y$10$J8cZOaiRDM5k08r00SAon.b8EhMpPflsVky3bZUIHfQfWadb0gvcK', NULL, 'satu', 'dua', '2015-02-12 23:17:22', '2015-02-15 04:31:28');
